...
export function AppFrame({ sidebar, children }: { sidebar: SidebarState; children: React.ReactNode }) {
  return (
    <SidebarProvider initialState={sidebar}>
      {/* 20rem is the narrowest phone; below that nothing is designed, so the frame stops shrinking there. */}
      <div className="flex min-h-full w-full min-w-80 bg-sidebar">
        <Sidebar />
