    ...
    <div className="grid grid-cols-1 gap-(--stack-gap) px-(--page-gutter) py-8 lg:grid-cols-[12rem_minmax(0,1fr)] lg:gap-12">
      ...
      <Stack gap="lg">
        ...
        <DsSection id="organisms" title="Organisms" description="Whole panels as the pages compose them, fed the fixture DTOs. What you see here is what the query layer's shape produces.">
          ...
          <Spec name="ActivityCalendar" file="website-traffic/activity-calendar.tsx" note="Follows the page range (D41), so it has no span control: GitHub-style squares, one column per week, capped at 1.5rem so thirty days stay compact and a year fills the width; below 42rem a year becomes month blocks, and the whole history is blocks at every width. The band under the grid carries the day, its week and its month."><ActivityCalendar activity={activity} range={activityRange} /></Spec>
